...
public class MysteriousCapModel extends Model {
	...
	public MysteriousCapModel(EntityRendererFactory.Context ctx, @Nullable EntityModel<?> wearerModel) {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData modelPartData1 = modelPartData.addChild("bone",
				ModelPartBuilder.create()
						.uv(0, 0)
						.cuboid(-12.0F, -3.0F, 4.0F, 9.0F, 3.0F, 9.0F)
						.uv(0, 0)
						.cuboid(-12.0F, -5.0F, 4.0F, 9.0F, 3.0F, 9.0F, new Dilation(-0.01F))
						.uv(0, 23)
						.cuboid(-7.0F, -4.05F, 4.0F, 4.0F, 1.0F, 9.0F)
						.uv(0, 0)
						.cuboid(-3.75F, -3.75F, 7.5F, 1.0F, 2.0F, 2.0F)
						.uv(23, 14)
						.cuboid(-3.075F, -1.0F, 4.0F, 4.0F, 1.0F, 9.0F),
				ModelTransform.pivot(5.5F, 24.0F, -8.5F)
		);
		modelPartData1.addChild("cube_r1",
				ModelPartBuilder.create()
						.uv(0, 12)
						.cuboid(-3.7F, -1.6F, -4.5F, 7.0F, 2.0F, 9.0F, new Dilation(0.01F)),
				ModelTransform.pivot(-6.1945F, -3.9853F, 8.5F)
		);
